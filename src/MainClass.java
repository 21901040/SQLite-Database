...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String dbFile = "C:\\Users\\domkm\\Documents\\sqlite\\db\\myfirst.db";
			...
			String sql2 = "insert into g_artists (name, a_type, a_year, debut, regdate)" 
				+ " values ('슈퍼주니어','남성', '2000년대, 2010년대, 2020년대', '2005년', datetime('now','localtime'));";
			...
			String sql3 = "update g_artists set a_year = '2000년 대,2010년대, 2020년대' "
					+ "where id=1 ;";
